  ...
  return (
    <header className="w-full max-w-4xl flex flex-col items-center py-12">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center mb-4">
        <a href={info.cvLink} className="text-blue-300 hover:underline text-lg">Curriculum Vitae</a>
        <span className="hidden sm:inline">|</span>
        <a href={`mailto:${info.email}`} className="text-blue-300 hover:underline text-lg">{info.email}</a>
        <span className="hidden sm:inline">|</span>
        <a href={info.blogLink} className="text-blue-300 hover:underline text-lg">Blog</a>
      </div>
